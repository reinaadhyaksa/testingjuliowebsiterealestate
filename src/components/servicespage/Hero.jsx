function Hero() {
    return (
        <section className="service-hero pt-32 pb-20 md:pt-40 md:pb-28 relative overflow-hidden bg-black">
            ...
            <div className="container mx-auto px-6 text-center relative z-10">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto font-poppins font-light leading-relaxed tracking-wide mb-8" data-aos="fade-up" data-aos-delay="200">
                    Solusi lengkap dan profesional untuk semua kebutuhan properti eksklusif Anda di Pekanbaru
                </p>

                {/* Features Grid */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-12" data-aos="fade-up" data-aos-delay="400">
